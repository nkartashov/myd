...
if __name__ == "__main__":
    ...
    remove_parser = subparsers.add_parser('remove', help='Removes a given container')
    ...
    wipe_parser = subparsers.add_parser('wipe', help='Wipes the files, generated by the program')

    prepare_unprivileged_parser = \
        subparsers.add_parser('prepare-unprivileged',
